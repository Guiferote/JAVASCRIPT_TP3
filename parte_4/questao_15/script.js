...
function calcularResultados() {
    ...
    const votosRoboRat = Number(prompt('Insira aqui a quantidade de votos para RoboRat:'));
    const votosSuperKeyboard = Number(prompt('Insira aqui a quantidade de votos para SuperKeyboard:'));
    const votosInvalidos = Number(prompt('Insira aqui a quantidade de votos inválidos:'));
    ...
    let percentualSuperKeyboardValidos = (votosSuperKeyboard / votosValidos) * 100;
    ...
    alert("Vamos para a porcentagem de votos!" + "\n" + 
        "RoboRat: " + percentualRoboRat + "%" + "\n"
        + "SuperKeyboard: " + percentualSuperKeyboard + "%" + "\n" + "Votos inválidos: " 
        + percentualInvalidos + "%");
    
    alert("Agora, a porcentagem dos votos VALIDOS de cada mascote!!!" 
        + "\n" + "RoboRat: " + percentualRoboRatValidos + "%" + "\n"
        + "SuperKeyboard: " + percentualSuperKeyboardValidos + "%");
