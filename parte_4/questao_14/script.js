...
function ordenaCrescente(maior, meio, menor){
    alert("Seus números em ordem crescente são: " + maior + " " + meio + " " + menor + " ");
}

function ordenaDecrescente(maior, meio, menor){
    alert("Seus números em ordem decrescente são: " + menor + " " + meio + " " + maior + " ");
}

function ordenaMaiorNoMeio(maior, meio, menor){
    alert("Seus números com o maior número no meio são: " + meio + " " + maior + " " + menor + " ");
}
