function analisaAptidaoDesconto(valorCompra, tipoComprador){
    ...
    if(tipoComprador === "gestante" || tipoComprador === "aposentado" || tipoComprador === "pensionista"){
...
let valorCompra = prompt("Vamos calcular seu desconto!" + "\n" + "Por favor, insira o valor da compra:");
...
if(porcentagemDesconto){
    ...
    alert("Você tem um desconto de " + porcentagemDesconto +"%!" + "\n" + 
        "O valor da sua compra já com desconto é: " + compraComDesconto);
}